...
//        }
        ...
        if (!clipboard.isDataFlavorAvailable(DataFlavor.stringFlavor) || clipboard.isDataFlavorAvailable(DataFlavor.imageFlavor) || clipboard.isDataFlavorAvailable(DataFlavor.javaFileListFlavor)) {
            try {
                Thread.sleep(5000);
            } catch (Exception e) {
            }
